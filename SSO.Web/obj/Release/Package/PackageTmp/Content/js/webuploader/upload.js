(function ($) {
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
            ...
            server: '../Handle/CSAppHandler.ashx?op=UploadFile',
        ...
        function updateStatus() {
            ...
            if (state === 'ready') {
                ...
                /*czy 2018年5月4日17:55:50*/
                $("#AppSize").val(WebUploader.formatSize(fileSize));
        ...
        uploader.on("startUpload", function () {
            ...
            //} else {
            $.post("../Handle/CSAppHandler.ashx?op=AppVersionAdd",
                   {
                       AppVersionId: $("#AppVersionId").val(),
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            if (response.chunked) {
                $.post("../Handle/CSAppHandler.ashx?op=MergeFile",
                    {
                        guid: GUID,
                        AppVersionId: $("#AppVersionId").val(),
                ...
                $.post("../Handle/CSAppHandler.ashx?op=VersionFileAdd",
                   {
                       AppVersionId: $("#AppVersionId").val(),
                       FileVersionCode: $("#VersionCode").val(),
                       FileName: escape(_fileName),
